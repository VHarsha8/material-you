    ...
    return(
        <div className="container mx-auto py-10 gap-6 md:px-20 px-6 flex flex-col">
            ...
            <div className="flex flex-col gap-4">
                ...
                <h1 className="font-poppins text-gray-700 text-xl font-medium">Join us on <div className="inline-flex text-green-600 text-xl font-poppins font-semibold items-center">September 28 2024</div>  and be a part of this celebration of talent and knowledge!</h1>
